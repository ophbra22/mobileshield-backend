...
def analyze(
    ...
    return {
        ...
        'input_domain': result.domain,
        'verdict': result.verdict,
        'confidence': result.confidence,
        'reasons': result.reasons,
        'strong_signals': result.signals.get('strong_signals') if result.signals else [],
        'weak_signals': result.signals.get('weak_signals') if result.signals else [],
